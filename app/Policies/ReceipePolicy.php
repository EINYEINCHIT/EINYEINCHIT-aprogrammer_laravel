...
class ReceipePolicy
{
    ...
    {
        return $receipe->author_id == $user->id || $user->id == 1; // can access current login user and super user (user1 is super user)
    }
    ...
    {
        return $receipe->author_id == $user->id || $user->id == 1; // user 1 is super user
    }
